...
public class AdaptadorMisCalificacionesTutor extends RecyclerView.Adapter<AdaptadorMisCalificacionesTutor.ExampleViewHolder> {
    ...
    public AdaptadorMisCalificacionesTutor(Context context, ArrayList<ItemMisCursosTutor> exampleList) {
        mContext = context;
    ...
    public ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_miscalificaciones, parent, false);
